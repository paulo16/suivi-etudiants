                    ...
                    <div class="col-lg-7 col-lg-offset-2">
                        ...
                        <form action="{{route('users.update',$user)}}" method="post" data-parsley-validate novalidate>
                          ...
                          <div class="form-group{{ $errors->has('prenom') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="prenom" parsley-trigger="change" required placeholder="Entrer le prenom" class="form-control" id="prenom" value="{{ old('prenom',$user->prenom) }}">
                            ...
                            <div class="row">
                              <div class="form-group col-lg-3">
                               ...
                               <select class="form-control" name="pays" id="pays">
                                   @foreach ($pays as $p)
                                      <option value="{{$p['id']}}"                                         @if($p['id'] == $user['pays_id']) selected="selected" @endif>
                                        {{$p['nom']}}
                                      </option>
                                   @endforeach
                               </select>
