            ...
            <div class="card-box table-responsive">
                ...
                <table id="etudiants-table" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th>{{ Lang::get('contenu.evolution_ville')}}</th>
                        <th>{{ Lang::get('contenu.evolution_filiere')}}</th>
                        <th>{{ Lang::get('contenu.evolution_etablissement')}}</th>
                        <th>Situation</th>
                    </tr>
                    </thead>
                </table>
        ...
        $(document).ready(function () {
            var table = $('#etudiants-table')
                .DataTable({
                    ...
                    columns: [
                        {data: 'nom', name: 'etudiants.nom'},
                        {data: 'prenom', name: 'etudiants.prenom'},
                        {data: 'naissance', name: 'etudiants.date_naissance'},
                        {data: 'genre', name: 'etudiants.genre'},
                        {data: 'promotion', name: 'etudiants.promotion'},
                        {data: 'ville', name: 'villes.nom'},
                        {data: 'filiere', name: 'filieres.nom'},
                        {data: 'ecole', name: 'etablissements.nom'},
                        {data: 'situation', name: 'evolutions.situation'},
