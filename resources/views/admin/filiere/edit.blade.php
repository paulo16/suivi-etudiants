            ...
            <div class="card-box table-responsive">
                ...
                <div class="row">
                    <div class="col-lg-7 col-lg-offset-2">
                        ...
                        <!-- Start add form -->
                        <form action="{{route('filieres.update',$filiere)}}" method="post" data-parsley-validate novalidate>
                          {{ csrf_field() }}
                          {{ method_field('PATCH') }}

                          <div class="form-group{{ $errors->has('nom') ? ' has-error' : '' }}">
                            <label for="nom">Nom*</label>
                            <input type="text" name="nom" parsley-trigger="change" required placeholder="Entrer le nom" class="form-control" id="nom" value="{{ old('nom',$filiere->nom) }}">
                          ...
                          <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="description" parsley-trigger="change" required placeholder="Entrer l'description" class="form-control" id="description" 
                            value="{{ old('description',$filiere->description) }}">
